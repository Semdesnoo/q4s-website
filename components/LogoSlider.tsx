...
function LogoItem({ logo }: { logo: (typeof logos)[number] }) {
  ...
  if (failed) {
    return (
      <div className="flex items-center justify-center h-[60px] sm:h-[88px] shrink-0 px-3 sm:px-10">
  ...
  return (
    <div className="flex items-center justify-center h-[60px] sm:h-[88px] shrink-0 px-3 sm:px-10">
      ...
      <img
        ...
        className="max-h-[40px] sm:max-h-[72px] max-w-[120px] sm:max-w-[240px] w-auto object-contain"
      />
    </div>
  );
}
